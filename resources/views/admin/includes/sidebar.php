...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="col text-left mt-2 mb-1"><small style="color: #a768b9;">{{user_position}}</small></div>
    <!-- Sidebar user panel (optional) -->
    <div class="user-panel pb-3 mb-3 d-flex">
      <div class="image" style="object-fit: cover;">
        <img src="{{user_img}}" class="img-circle elevation-2" alt="User Image" style="object-fit: cover;">
      </div>
      <div class="info">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{menu_open_forms}}">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{URL}}/dashboard/forms/account" class="nav-link {{active_forms_account}}">
