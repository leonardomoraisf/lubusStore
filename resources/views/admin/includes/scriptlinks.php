...
<!-- Summernote -->
<script src="{{URL}}/resources/assets/admin/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
...
<script src="{{URL}}/resources/assets/admin/dist/js/pages/dashboard.js"></script>
<!-- Modals e Alerts -->
